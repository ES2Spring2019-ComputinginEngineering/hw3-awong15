...
#*****************************************
# YOUR NAME: Aycia Wong
# NUMBER OF MINUTES TO COMPLETE: 20
# YOUR COLLABORATION STATEMENT(s): I worked alone on this
#
#
#*****************************************
...
def draw_asteroid(asteroid_x, asteroid_y):
    display.set_pixel(asteroid_x, asteroid_y, 7)
...
while True:
    ...
    if score > 10:
        Frame_Rate_In_Milliseconds = 400
    if score > 15:
        Frame_Rate_In_Milliseconds = 350
    if score > 25:
        Frame_Rate_In_Milliseconds = 300
    if score > 50:
        Frame_Rate_In_Milliseconds = 250
    if score > 100:
        Frame_Rate_In_Milliseconds = 200
    if score > 150:
        Frame_Rate_In_Milliseconds = 150
